    ...
    <div class="container py-5">
        ...
        <div class="d-grid gap-2" >
            <button  style="border-radius: 10px;box-shadow: 10px 1px 10px gray; background-color:#327a6d; color: white; font-size: 150%;" class="btn " type="button">
                <b>V I S I & M I S I</b></button>
            </div><br>
        
            <!--card 1-->
            <div class="card mb-3">
                <img src="{{ asset('img/visimisi.jpg') }}" class="card-img-top" alt="...">
                <div class="card-body">
                  <p class="card-text">
                <b> VISI</b> pembangunan Desa Sukamaju tahun 2023-2030 adalah "Mewujudkan Desa Sukamaju
                yang unggul, sejahtera, santih, dan berbudaya".
                  </p>

                  <p class="card-text">
                    <b>MISI</b> pembangunan Desa Sukamaju tahun 2023-2030 adalah:
                    <li>
                    Peningkatan kualitas sumber daya manusia
                    </li>
                    <li>
                    Peningkatan pembangunan di segala bidang
                    </li>
                    <li>
